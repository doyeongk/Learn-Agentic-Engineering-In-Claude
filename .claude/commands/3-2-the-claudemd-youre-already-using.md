# Module 3.2: The CLAUDE.md You're Already Using
...
2. Read the module content file at `docs-site/docs/03-context-engineering/3.2-the-claudemd-youre-already-using.md`.
