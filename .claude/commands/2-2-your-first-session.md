# Module 2.2: Your First Claude Code Session

Read the module content at `docs-site/docs/02-meet-claude-code/2.2-your-first-session.md` and deliver it following the training delivery skill.
...
2. Read the module content file at `docs-site/docs/02-meet-claude-code/2.2-your-first-session.md`.
