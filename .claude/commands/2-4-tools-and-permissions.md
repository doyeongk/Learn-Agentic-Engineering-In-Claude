# Module 2.4: Tools and Permissions

Read the module content at `docs-site/docs/02-meet-claude-code/2.4-tools-and-permissions.md` and deliver it following the training delivery skill.
...
2. Read the module content file at `docs-site/docs/02-meet-claude-code/2.4-tools-and-permissions.md`.
