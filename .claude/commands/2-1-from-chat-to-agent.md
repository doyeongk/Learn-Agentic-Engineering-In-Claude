# Module 2.1: From Chat to Agent

Read the module content at `docs-site/docs/02-meet-claude-code/2.1-from-chat-to-agent.md` and deliver it following the training delivery skill.
...
2. Read the module content file at `docs-site/docs/02-meet-claude-code/2.1-from-chat-to-agent.md`.
