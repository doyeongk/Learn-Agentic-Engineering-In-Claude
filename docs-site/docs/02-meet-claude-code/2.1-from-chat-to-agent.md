...
This shift is often described as the move from **implementer to orchestrator**. Instead of writing every line of code yourself, you describe the outcome you want and supervise the agent as it works. Your job changes from doing the mechanical work to providing direction, reviewing results, and making judgment calls.

<div style={{display: 'flex', flexDirection: 'column', gap: '1.5rem', margin: '2rem 0'}}>
<div style={{border: '2px solid var(--ifm-color-emphasis-300)', borderRadius: '12px', padding: '1.5rem'}}>
<h4 style={{margin: '0 0 1rem 0', opacity: 0.7}}>Chat Paradigm (Claude Desktop)</h4>
<div style={{display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '1.1rem'}}>
<span style={{background: 'var(--ifm-color-emphasis-200)', padding: '0.5rem 1rem', borderRadius: '8px', width: 'fit-content'}}>1. You type a question</span>
<span style={{background: 'var(--ifm-color-emphasis-200)', padding: '0.5rem 1rem', borderRadius: '8px', width: 'fit-content'}}>2. AI types an answer</span>
<span style={{background: 'var(--ifm-color-emphasis-200)', padding: '0.5rem 1rem', borderRadius: '8px', width: 'fit-content'}}>3. You do the work yourself</span>
</div>
</div>

<div style={{border: '2px solid var(--ifm-color-primary)', borderRadius: '12px', padding: '1.5rem'}}>
<h4 style={{margin: '0 0 1rem 0', color: 'var(--ifm-color-primary)'}}>Agent Paradigm (Claude Code)</h4>
<div style={{display: 'flex', flexDirection: 'column', gap: '0.5rem', fontSize: '1.1rem'}}>
<span style={{background: 'var(--ifm-color-emphasis-200)', padding: '0.5rem 1rem', borderRadius: '8px', width: 'fit-content'}}>1. You describe what you want</span>
<span style={{background: 'var(--ifm-color-emphasis-200)', padding: '0.5rem 1rem', borderRadius: '8px', width: 'fit-content'}}>2. AI reads files, writes code, runs commands</span>
<span style={{background: 'var(--ifm-color-emphasis-200)', padding: '0.5rem 1rem', borderRadius: '8px', width: 'fit-content'}}>3. AI checks the result — loops back to step 2 if needed</span>
<span style={{background: 'var(--ifm-color-emphasis-200)', padding: '0.5rem 1rem', borderRadius: '8px', width: 'fit-content'}}>4. Done — you review</span>
</div>
</div>
</div>
